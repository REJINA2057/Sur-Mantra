		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addBrandModel"> <i
							class="glyphicon glyphicon-plus-sign"></i> Add Supplier </button>
				</div> <!-- /div-action -->
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitSupplierForm" action="php_action/createSupplier.php" method="POST">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="supplierPhone" class="col-sm-3 control-label">Supplier Phone: </label>
						<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="supplierPhone" placeholder="Supplier Phone"
								name="supplierPhone" autocomplete="off">
						</div>
					</div>

					<div class="form-group">
						<label for="supplierAddress" class="col-sm-3 control-label">Supplier Address: </label>
						<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="supplierAddress" placeholder="Supplier Address"
								name="supplierAddress" autocomplete="off">
						</div>
					</div>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary" id="createSupplierBtn" data-loading-text="Loading..."
				...
				<div class="modal-body">
					...
					<div class="edit-brand-result">
						<div class="form-group">
							...
							<label class="col-sm-1 control-label">: </label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="editSupplierName" placeholder="Supplier Name"
									name="editSupplierName" autocomplete="off">
							</div>
						</div> <!-- /form-group-->
						<div class="edit-brand-result">
							<div class="form-group">
								<label for="editSupplierPhone" class="col-sm-3 control-label">Supplier Phone: </label>
								<label class="col-sm-1 control-label">: </label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="editSupplierPhone" placeholder="Supplier Phone"
										name="editSupplierPhone" autocomplete="off">
								</div>
							</div> <!-- /form-group-->

							<div class="edit-brand-result">
								<div class="form-group">
									<label for="editSupplierAddress" class="col-sm-3 control-label">Supplier Address: </label>
									<label class="col-sm-1 control-label">: </label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="editSupplierAddress" placeholder="Supplier Address"
											name="editSupplierAddress" autocomplete="off">
									</div>
								</div> <!-- /form-group-->
								<div class="form-group">
						...
						<div class="modal-footer editBrandFooter">
							...
							<button type="submit" class="btn btn-success" id="editSupplierBtn" data-loading-text="Loading..."
...
<!-- remove brand -->
<div class="modal fade" tabindex="-1" role="dialog" id="removeSupplierMemberModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
			...
			<div class="modal-footer removeBrandFooter">
				<button type="button" class="btn btn-default" data-dismiss="modal"> <i
						class="glyphicon glyphicon-remove-sign"></i> Close</button>
				<button type="button" class="btn btn-primary" id="removeSupplierBtn" data-loading-text="Loading..."> <i
